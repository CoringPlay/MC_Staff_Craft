...
import net.mcreator.staffcraft.procedures.FireStaffBulletHitsLivingEntityProcedure;
import net.mcreator.staffcraft.procedures.FireStaffBulletHitsBlockProcedure;
...
public class FireStaffItem extends StaffCraftModElements.ModElement {
	@ObjectHolder("staff_craft:fire_staff")
	public static final Item block = null;
	@ObjectHolder("staff_craft:entitybulletfire_staff")
	public static final EntityType arrow = null;
	public FireStaffItem(StaffCraftModElements instance) {
		super(instance, 1);
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				FireStaffBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					FireStaffBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
